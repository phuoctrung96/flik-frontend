      ...
      <div className="checkoutConfirm__container">
        <div className="checkoutConfirm__shopContainer">
          <div className="checkoutConfirm__shopContainer-left">
            ...
            <p className="checkoutConfirm__shopContainer-left-title">THE BODY SHOP</p>
          </div>
          <div className="checkoutConfirm__shopContainer-right">
            <img src={Icons.shoppingCart} width={16} height={16} alt="" />
            <p className="checkoutConfirm__shopContainer-right-title">Rp 270.600</p>
          ...
          <Box className="checkoutConfirm__formInfor-cardInfoContainer">
            ...
            <Box className="checkoutConfirm__formInfor-cardInfoContainer-descriptionContainer">
              <p className="checkoutConfirm__formInfor-cardInfoContainer-descriptionText">
                A verification code has been sent to your mobile phone <b>+6282123456789</b>. Enter
                the authorization code to approve this transaction before the transaction timer runs
                out
              </p>
            </Box>
            <p className="checkoutConfirm__formInfor-cardInfoContainer-confirmText">
              Confirm your transaction in <span style={{ color: '#0085FF' }}>04:50</span>
            </p>
          </Box>

          <Box className="checkoutConfirm__formInfor-detailContainer">
            <Box sx={{ ...RootStyles.row, mb: '10px', alignItems: 'flex-start' }}>
              <p className="checkoutConfirm__formInfor-detailContainer-label">Merchant Name</p>
              <p className="checkoutConfirm__formInfor-detailContainer-value">Flik</p>
            </Box>

            <Box sx={{ ...RootStyles.row, mb: '10px', alignItems: 'flex-start' }}>
              <p className="checkoutConfirm__formInfor-detailContainer-label">Amount</p>
              <p className="checkoutConfirm__formInfor-detailContainer-value">Rp 377.300</p>
            </Box>

            <Box sx={{ ...RootStyles.row, mb: '10px', alignItems: 'flex-start' }}>
              <p className="checkoutConfirm__formInfor-detailContainer-label">Transaction Date</p>
            ...
            <Box sx={{ ...RootStyles.row, mb: '10px', alignItems: 'flex-start' }}>
              <p className="checkoutConfirm__formInfor-detailContainer-label">Visa Number</p>
              <p className="checkoutConfirm__formInfor-detailContainer-value">
                4321 5678 9012 0488
              </p>
            </Box>
            ...
            <Box sx={{ ...RootStyles.row }}>
              <p className="checkoutConfirm__formInfor-detailContainer-label">Authorization Code</p>
              <Input
                variant="outlined"
                size="small"
                fullWidth
            ...
            <p className="checkoutConfirm__formInfor-detailContainer-tag">Powered by Flik</p>
          </Box>
