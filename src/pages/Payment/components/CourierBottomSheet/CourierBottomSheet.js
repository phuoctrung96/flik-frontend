...
export const CourierBottomSheet = ({ onClose, isVisibled, courierList, onSave, className }) => {
  return (
    <BottomSheet open={isVisibled} className="courier" onDismiss={onClose}>
      <LibraryIcons.CloseIcon className="courier__closeIcon" onClick={onClose} />
      ...
      <div className="courier__buttonContainer">
        <Button isPrimary fullWidth className="courier__button" onClick={onSave}>
          Save
        </Button>
      </div>
    </BottomSheet>
